...
class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        var logout = LogoutViewController()
        ...
        viewControllers = [
            ...
            generateViewController(rootViewController: loginVC,
                                   image: UIImage(named: "logout")!, title: "Login"),
            generateViewController(rootViewController: registerVC,
                                   image:  UIImage(named: "person.badge.plus")!,
                                   title: "Register"),
            generateViewController(rootViewController: logout,
                                   image:  UIImage(named: "person.badge.minus")!,
                                   title: "Log Out"),
        ]
    }
